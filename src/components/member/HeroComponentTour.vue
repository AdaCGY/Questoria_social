        ...
        <div class="row align-items-center">
          <div class="col-lg-7">
            <div class="hero-text aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
              <h1 class="hero-title">你是你所選擇的樣子</h1>
              <p class="hero-subtitle">登入，繼續記錄你曾經活過的時刻</p>
              <div class="hero-buttons">
                <a href="#" class="btn btn-primary me-3">Register</a>
                <RouterLink :to="{ path: '/', hash: '#heroQS' }" class="btn btn-outline">Home</RouterLink>
          ...
          <div class="col-lg-5">
            <div class="booking-form-wrapper aos-init aos-animate" data-aos="fade-left" data-aos-delay="200">
